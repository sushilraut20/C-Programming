...
int main()
{
 ...
 matrix1=(float **)malloc(r*sizeof(float *));
 matrix2=(float **)malloc(r*sizeof(float *));
 matrix_Matrix_Multiplication_Result=(float **)malloc(r*sizeof(float *));

 for(i=0;i<r;i++)
 {
 matrix1[i]=(float *)malloc(c*sizeof(float));
 matrix2[i]=(float *)malloc(c*sizeof(float));
 ...
 if(matrix1==NULL || matrix2==NULL || matrix_Matrix_Multiplication_Result==NULL || vector==NULL || matrix_Vector_Multiplication_Result==NULL )
 {
 ...
 matrix1=insert_Data_Into_The_Matrix(matrix1,r,c);
 matrix2=insert_Data_Into_The_Matrix(matrix2,r,c);
 vector=insert_Data_Into_The_Vector(vector,r);

 gettimeofday(&start, NULL);
 matrix_Matrix_Multiplication_Result=matrix_Matrix_Multiplication(matrix1,matrix2,matrix_Matrix_Multiplication_Result,r,c);
// matrix_Vector_Multiplication_Result=matrix_Vector_Multiplication(matrix1,vector,matrix_Vector_Multiplication_Result,r,c);
